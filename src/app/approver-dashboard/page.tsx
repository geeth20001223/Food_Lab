...
export default function LabAnalystDashboard() {
  ...
  const computeAvgsFromItem = (item: SavedAnalysis) => {
    ...
    const acidII =
      a2ii - a1ii > 0 ? ((ac2ii - ac1ii) * 100) / (a2ii - a1ii) : 0;
  ...
  const toggleComplete = async (item: SavedAnalysis) => {
    const newStatus = !(
      item.analysis_complete === 1 || item.analysis_complete === true
    );
    try {
  ...
  const handlePrint = () => {
    ...
    const moistI =
      Number(form.moist_m2_i) - Number(form.moist_m3_i) > 0
        ? ((Number(form.moist_m2_i) - Number(form.moist_m3_i)) * 100) /
          (Number(form.moist_m2_i) - Number(form.moist_m1_i))
        : 0;
    const moistII =
      Number(form.moist_m2_ii) - Number(form.moist_m3_ii) > 0
        ? ((Number(form.moist_m2_ii) - Number(form.moist_m3_ii)) * 100) /
          (Number(form.moist_m2_ii) - Number(form.moist_m1_ii))
        : 0;
    const moistAvg = (moistI + moistII) / 2;

    const ashI =
      Number(form.ash_m2_i) - Number(form.ash_m1_i) > 0
        ? ((Number(form.ash_m3_i) - Number(form.ash_m1_i)) * 100) /
          (Number(form.ash_m2_i) - Number(form.ash_m1_i))
        : 0;
    const ashII =
      Number(form.ash_m2_ii) - Number(form.ash_m1_ii) > 0
        ? ((Number(form.ash_m3_ii) - Number(form.ash_m1_ii)) * 100) /
          (Number(form.ash_m2_ii) - Number(form.ash_m1_ii))
        : 0;
    const ashAvg = (ashI + ashII) / 2;

    const acidI =
      Number(form.ash_m2_i) - Number(form.ash_m1_i) > 0
        ? ((Number(form.acid_m2_i) - Number(form.ash_m1_i)) * 100) /
          (Number(form.ash_m2_i) - Number(form.ash_m1_i))
        : 0;
    const acidII =
      Number(form.ash_m2_ii) - Number(form.ash_m1_ii) > 0
        ? ((Number(form.acid_m2_ii) - Number(form.ash_m1_ii)) * 100) /
          (Number(form.ash_m2_ii) - Number(form.ash_m1_ii))
        : 0;
    const acidAvg = (acidI + acidII) / 2;
        ...
        <div>
          ...
          <div className="space-y-6">
                    ...
                    <div style={{ display: "flex", gap: "0.625rem" }}>
                      <div style={{ flex: 1, position: "relative" }}>
                        <input
                          ...
                          onFocus={() => {
                            if (searchSample === "") setSearchSample(" ");
                            setTimeout(() => {
                              if (searchSample === " ") setSearchSample("");
                            }, 10);
                          }}
                        ...
                        {searchSample.length > 0 && (
                          ...
                          >
                            ...
                            {samples.filter((s) =>
                              s.sample_number
                                .toLowerCase()
                                .includes(searchSample.toLowerCase()),
                            ).length === 0 && (
                              <div
                                style={{
                                  padding: "1rem",
            ...
            {selectedSampleId &&
              (() => {
                const isApprover =
                  userRole === "Approving Officer" || userRole === "Admin";
                ...
                return (
                  <div className="animation-fade-in space-y-8">
                    {isSaved && !isApprover && (
                      ...
                      >
                        🔒 This record has been saved. Only an Approving Officer
                        can make changes.
                      </div>
                    )}
                    <fieldset
                            ...
                            <table className="w-full text-sm">
                              ...
                              <tbody className="divide-y">
                                ...
                                <tr className="bg-gray-50 text-indigo-900 font-medium border-y">
                                  <td className="p-2">
                                    Mass of sample (m2 - m1)
                                  </td>
                                  <td className="text-center">
                                    {(
                                      form.moist_m2_i - form.moist_m1_i
                                    ).toFixed(4)}
                                  </td>
                                  <td className="text-center">
                                    {(
                                      form.moist_m2_ii - form.moist_m1_ii
                                    ).toFixed(4)}
                                  </td>
                                </tr>
                                <tr>
                          ...
                          <section className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                            ...
                            <textarea
                              ...
                              onChange={(e) =>
                                setForm({
                                  ...form,
                                  microscope_notes: e.target.value,
                                })
                              }
                            />
                          </section>
                            ...
                            <table className="w-full text-sm">
                              ...
                              <tbody className="divide-y">
                                ...
                                <tr className="bg-gray-50 text-indigo-900 font-medium border-y">
                                  ...
                                  <td className="text-center">
                                    {(form.ash_m2_ii - form.ash_m1_ii).toFixed(
                                      4,
                                    )}
                                  </td>
                                </tr>
                            ...
                            <table className="w-full text-sm">
                              ...
                              <tbody className="divide-y">
                                ...
                                <tr className="bg-gray-50 text-indigo-900 font-medium border-y">
                                  ...
                                  <td className="text-center">
                                    {(form.acid_m2_i - form.acid_m1_i).toFixed(
                                      4,
                                    )}
                                  </td>
                                  <td className="text-center">
                                    {(
                                      form.acid_m2_ii - form.acid_m1_ii
                                    ).toFixed(4)}
                                  </td>
                                </tr>
                                <tr className="bg-indigo-50 font-bold">
                      ...
                      <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 space-y-8">
                        ...
                        <div className={!canEdit ? "form-locked" : ""}>
                          ...
                          <p className="text-xs text-gray-400 mt-2 italic">
                            * These print configurations are only for generating
                            the PDF and will not be saved into the analytical
                            database record.
                          </p>
                        </div>
                      </div>
